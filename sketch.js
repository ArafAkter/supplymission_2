...
packageBody = Bodies.circle(width/2 , 200 , 5 , {restitution:0.5, box_options});
   ...
   redzone1 = Bodies.rectangle(width/2, 640, 200, 20 , {isStatic:true} );
   World.add(world, redzone1);

   redzone2 = Bodies.rectangle(width/2 - 190, 600, 20, 100 , {isStatic:true} );
   World.add(world, redzone1);

   redzone3 = Bodies.rectangle(width/2 + 190, 600, 20, 100 , {isStatic:true} );
   World.add(world, redzone1);
